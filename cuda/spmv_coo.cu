...
int main() {
    ...
    values_d_buf.copy_from_host(coo_matrix.values, static_cast<std::size_t>(coo_matrix.num_none_zeros));
    row_indices_d_buf.copy_from_host(coo_matrix.row_indices, static_cast<std::size_t>(coo_matrix.num_none_zeros));
    col_indices_d_buf.copy_from_host(coo_matrix.col_indices, static_cast<std::size_t>(coo_matrix.num_none_zeros));
